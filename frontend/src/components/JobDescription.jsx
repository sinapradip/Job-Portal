  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
      ...
      <div className='my-4'>
        ...
        <h1 className='font-bold my-1'>Location: <span className='pl-4 font-normal text-gray-800'>Chitwan</span></h1>
        ...
        <h1 className='font-bold my-1'>Salary: <span className='pl-4 font-normal text-gray-800'>Rs. 40,000</span></h1>
        <h1 className='font-bold my-1'>Total Applicants: <span className='pl-4 font-normal text-gray-800'>4</span></h1>
        <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>12/6/2024</span></h1>
      </div>
